...
console.log(JSON.stringify(heroes, ["name", "publisher"], 5))

const transforma=(clave, valor)=>{
    if(clave=="id") return 9000 + valor
    if(clave=="name" || clave=="publisher") return valor.toUpperCase()
    
    return valor
}


console.log(JSON.stringify(heroes, transforma, 5))