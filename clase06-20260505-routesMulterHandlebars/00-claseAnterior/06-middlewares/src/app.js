...
const { logger, logger2, formatUser, auth } = require("./middlewares/middlewares.js")
...
//     return res.status(200).json({payload:"de nuevo home json"});
// })
...
app.post("/users", auth, formatUser ,async (req, res) => {  //request / response
