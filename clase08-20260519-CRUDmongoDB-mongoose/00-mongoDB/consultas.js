...
db.alumnosPrueba.insertOne({ email: "carlos@test.com" })
db.alumnosPrueba.insertOne({ email: "carlosIV@test.com", _id: 70 })
db.alumnosPrueba.insertOne({ email: "carlosIV@test.com", id: 70, code: 70 })
...
db.heroes.find({ publisher: "Marvel" })
db.heroes.find({ publisher: "Marvel", id: 1 })


db.heroes.find({ id: { $gt: 8 } })
db.heroes.find({ id: { $lte: 8 } })
db.heroes.find({ id: { $lte: 8 }, publisher: "DC" })


db.heroes.find({ name: { $in: ["Batman", "Superman"] } })

db.heroes.find({
    $or: [
        { name: { $in: ["Hulk", "Superman"] } },
        { id: { $gt: 18 } },
        { name: { $regex: /bat/ } },
        { name: { $regex: /Bat/ } },
    ]
...
db.heroes.find(
    ...
    {
        enemies: 0, alias: 0, _id: 0, powers: 0, id: 0, publisher:0, 
    }
)
...
).sort({team: -1, name: 1}).skip(8).limit(3)
...
db.heroes.updateOne({name:"Hulk"}, {$unset: {name: 1}})
db.heroes.updateOne({alias:"Bruce Banner"}, {$set: {name: "Hulk", edad: 42}})
db.heroes.updateOne({name:"Hulk"}, {$rename: {edad: "age"}})
db.heroes.updateOne({name:"Hulk"}, {$inc: {edad: 3}})
db.heroes.updateOne({name:"Hulk"}, {$inc: {age: 3}, $unset: {edad: 1}})
db.heroes.updateOne({name:"Hulk"}, {$mul: {age: 3}})

db.heroes.updateMany({publisher: "DC"}, {$inc: {id: 9000}})
...
db.heroes.deleteMany({publisher: {$regex:/DC/}})